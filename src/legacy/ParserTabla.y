...
REPETICIONDET:   for identifier colon TYPE from EXPRESION to EXPRESION NUEVOBLOQUE INSTRUCCIONESC Nl end               {% do {tryInsert $2 $4; finalizarBloqueU; return $ RepDet $2 $4 $6 $8 Nothing (reverse $10) } }
                 | for identifier colon TYPE from EXPRESION to EXPRESION by number NUEVOBLOQUE INSTRUCCIONESC Nl end   {% do {tryInsert $2 $4; finalizarBloqueU; return $ RepDet $2 $4 $6 $8 (Just $10) (reverse $12) } }
                 | for identifier colon TYPE in EXPRESION NUEVOBLOQUE INSTRUCCIONESC Nl end                            {% do {tryInsert $2 $4; finalizarBloqueU; return $ RepDetArray $2 $4 $6 (reverse $8) } }

-- Especial para Funcion
REPETICIONDETF:  for identifier colon TYPE from EXPRESION to EXPRESION NUEVOBLOQUE INSTSFUNC Nl end                   {% do {tryInsert $2 $4; finalizarBloqueU; return $ RepDet $2 $4 $6 $8 Nothing (reverse $10) } }
                 | for identifier colon TYPE from EXPRESION to EXPRESION by number NUEVOBLOQUE INSTSFUNC Nl end       {% do {tryInsert $2 $4; finalizarBloqueU; return $ RepDet $2 $4 $6 $8 (Just $10) (reverse $12) } }
                 | for identifier colon TYPE in EXPRESION NUEVOBLOQUE INSTSFUNC Nl end                                {% do {tryInsert $2 $4; finalizarBloqueU; return $ RepDetArray $2 $4 $6 (reverse $8) } }
